...
import polimi.trex.client.ruleparser.TESLAParser.Agg_betweenContext;
import polimi.trex.client.ruleparser.TESLAParser.Agg_one_referenceContext;
import polimi.trex.client.ruleparser.TESLAParser.Aggregate_atomContext;
import polimi.trex.client.ruleparser.TESLAParser.Attr_constraintContext;
import polimi.trex.client.ruleparser.TESLAParser.Attr_declarationContext;
import polimi.trex.client.ruleparser.TESLAParser.Attr_definitionContext;
import polimi.trex.client.ruleparser.TESLAParser.Attr_parameterContext;
import polimi.trex.client.ruleparser.TESLAParser.ExprContext;
import polimi.trex.client.ruleparser.TESLAParser.Neg_betweenContext;
import polimi.trex.client.ruleparser.TESLAParser.Neg_one_referenceContext;
import polimi.trex.client.ruleparser.TESLAParser.Packet_referenceContext;
import polimi.trex.client.ruleparser.TESLAParser.Param_atomContext;
import polimi.trex.client.ruleparser.TESLAParser.Param_mappingContext;
import polimi.trex.client.ruleparser.TESLAParser.PredicateContext;
import polimi.trex.client.ruleparser.TESLAParser.StaticAttr_definitionContext;
...
public class TESLABaseListener implements TESLAListener {
	...
	@Override public void enterEnding_rule(@NotNull TESLAParser.Ending_ruleContext ctx) { 
		...
		rule = new RulePacket(rule_template);
